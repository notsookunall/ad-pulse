  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 bg-background">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-4">Simple, Transparent Pricing</h1>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <Card className="bg-white/5 border-white/10 flex flex-col">
          <CardHeader>
            ...
            <p className="text-sm text-gray-400 mt-2">Essential tools for small businesses.</p>
          </CardHeader>
        ...
        {/* Professional Plan */}
        <Card className="bg-white/10 border-indigo-500/50 relative flex flex-col shadow-2xl shadow-indigo-500/10 scale-105 z-10">
          ...
          <CardHeader>
            ...
            <p className="text-sm text-gray-400 mt-2">Advanced features for growing agencies.</p>
          </CardHeader>
          <CardContent className="flex-1">
            <ul className="space-y-4 mt-4">
              {[
        ...
        <Card className="bg-white/5 border-white/10 flex flex-col">
          <CardHeader>
            ...
            <p className="text-sm text-gray-400 mt-2">Maximum power for large organizations.</p>
          </CardHeader>
          <CardContent className="flex-1">
            <ul className="space-y-4 mt-4">
              {[
